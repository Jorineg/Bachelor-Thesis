...
%------------------------------
% These settings help prevent orphan headings
\clubpenalty=10000     % penalty for breaking after first line of paragraph
\widowpenalty=10000    % penalty for breaking before last line of paragraph
\displaywidowpenalty=10000  % penalty for breaking before last line before display
\brokenpenalty=10000   % penalty for breaking after hyphenated line
\predisplaypenalty=10000    % penalty for breaking before display
\postdisplaypenalty=1000    % penalty for breaking after display
\interlinepenalty=0         % penalty for breaking in the middle of a paragraph

% Additional penalties for section headings
\@secpenalty = -300    % penalty for breaking after section heading
\@subsecpenalty = -300 % penalty for breaking after subsection heading