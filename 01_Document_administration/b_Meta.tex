...
\newcommand{\englishkeywords}{%
    High-Performance Computing; Stencil Computations; Cerebras WSE; Tiling; 2D Stencils; Performance Optimization; Domain Decomposition%
}
\newcommand{\germankeywords}{%
    Hochleistungsrechnen; Stencil-Berechnungen; Cerebras WSE; Kachelung; 2D-Stencils; Leistungsoptimierung; Gebietszerlegung%
}
%-----------------------------
% FOR DISSERTATION
%-----------------------------
