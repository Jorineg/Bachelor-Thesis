...
In the optimal configuraion, our implementation may reasonably be expected to reach a sustained performance of 1.01 P\ac{flops} for \ac{wse}-2 and 1.29 P\ac{flops} for \ac{wse}-3.
