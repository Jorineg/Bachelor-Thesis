...
In the optimal configuration, our implementation may reasonably be expected to reach a sustained performance of 1.01 P\acp{flops} for the \ac{wse}-2 and 1.29 P\acp{flops} for the \ac{wse}-3.
